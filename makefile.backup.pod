...
OPENBLAS_PATH=/public/apps/openblas/0.2.13/gcc.4.7.2/lib
...
LIBS := -L$(MATLAB_INSTALL_PATH)/bin/glnxa64 -L$(ARPACKPP_DIR)/external -L$(LAPACK_PATH) -L$(OPENBLAS_PATH)

#put non cuda -l* stuff here
NONCU_LIBS:=-larpack -lsuperlu -lgfortran -llapack -lblas
